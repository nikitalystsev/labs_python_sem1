...
def sort_array():
    ...
    array = [0] * n
    for i in range(n):
        array[i] = ch.clever_input('Введите целое число - {}-й элемент списка: '.format(i + 1))
...
information_for_first_dimension_1 = [timeit.timeit('shell_sort(list1_sorted)', number=1, globals=globals()),
                                     timeit.timeit('shell_sort(list1_reverse_sorted)', number=1, globals=globals()),
...
information_for_second_dimension_1 = [timeit.timeit('shell_sort(list2_sorted)', number=1, globals=globals()),
                                      timeit.timeit('shell_sort(list2_reverse_sorted)', number=1, globals=globals()),
...
information_for_third_dimension_1 = [timeit.timeit('shell_sort(list3_sorted)', number=1, globals=globals()),
                                     timeit.timeit('shell_sort(list3_reverse_sorted)', number=1, globals=globals()),
